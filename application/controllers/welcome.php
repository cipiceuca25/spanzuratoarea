...
class Welcome extends CI_Controller {
	...
	public function newroom()
	{
		...
		else
		{
			...
			$this->load->view( "header", array("pagetitle" => $this->input->post( "name" ) . " - Camera noua") );
	...
	public function waitroom()
	{
		...
		if( $this->room !== false )
		{
			...
			if( $this->room["current_mode"] == "0" )
			{
				...
				$this->load->view( "header", array( "pagetitle" => $this->room["name"] . " - In asteptare de jucatori" ) );
	...
	public function guessing()
	{
		...
		else
		{
			...
			if( $this->room["guest_guessing"] == $this->guestid )
			{
				...
				$this->load->view( "header", array( "pagetitle" => $this->room["name"] . " - Alege o litera" ) );
			...
			{
				$this->load->view( "header", array( "pagetitle" => $this->room["name"] . " - Asteapta, este randul altcuiva" ) );
